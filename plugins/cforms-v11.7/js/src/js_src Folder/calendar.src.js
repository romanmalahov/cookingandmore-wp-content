			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="#" class="dp-choose-date" title="' + $.dpText.TEXT_CHOOSE_DATE + '"><img class="imgcalendar" src="'+$.dpText.ROOT+'/js/calendar.gif" alt=""/></a>')
								.bind(
									'click',
									function()
									{
						...
						$('<div></div>')
							...
							.append(
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '"><img src="'+$.dpText.ROOT+'/js/cal_p_year.gif" alt=""/></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"><img src="'+$.dpText.ROOT+'/js/cal_p_month.gif" alt=""/></a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '"><img src="'+$.dpText.ROOT+'/js/cal_n_year.gif" alt=""/></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"><img src="'+$.dpText.ROOT+'/js/cal_n_month.gif" alt=""/></a>')
											.bind(
												'click',
												function()
												{
