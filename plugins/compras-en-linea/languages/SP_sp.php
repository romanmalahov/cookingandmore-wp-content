...
define('TXT_WPSC_CATEGORYIMAGEHEIGHT', utf8_encode('Alto imagen categoría'));

define('TXT_WPSC_PRODUCTLISTURL', utf8_encode('Posición de la lista de productos'));

define('TXT_WPSC_SHOPPINGCARTURL', utf8_encode('Posición del carrito de compra'));

define('TXT_WPSC_CHECKOUTURL', utf8_encode('Posición de la página de compra'));

define('TXT_WPSC_TRANSACTURL', utf8_encode('Posición de la página de detalle de transacción'));

define('TXT_WPSC_PAYMENTGATEWAY', utf8_encode('Pasarela de pago a usar'));

define('TXT_WPSC_CARTLOCATION', utf8_encode('Posición de carrito'));

define('TXT_WPSC_SHOWCATEGORYBRANDS', utf8_encode('Mostrar categorías o tipos o ambos'));

define('TXT_WPSC_CURRENCYTYPE', utf8_encode('Tipo de moneda'));

define('TXT_WPSC_CURRENCYSIGNLOCATION', utf8_encode('Posición del símbolo de moneda'));

define('TXT_WPSC_GSTRATE', utf8_encode('GST'));

define('TXT_WPSC_MAXDOWNLOADS', utf8_encode('Límite de descarga'));

define('TXT_WPSC_DISPLAYPNP', utf8_encode('Mostrar u ocultar franqueo y empaquetado'));

define('TXT_WPSC_DISPLAYSPECIALS', utf8_encode('Mostrar u ocultar ofertas en la barra de menú'));

define('TXT_WPSC_POSTAGEAND_PACKAGING', utf8_encode('Franqueo y empaquetado por defecto'));

define('TXT_WPSC_PURCHLOGEMAIL', utf8_encode('Dirección de correo donde se envía el registro de compra'));

define('TXT_WPSC_RETURNEMAIL', utf8_encode('Dirección de correo desde donde se envían los informes'));
...
define('TXT_WPSC_DEFAULTCATEGORY', utf8_encode('Categoría por defecto'));
...
define('TXT_WPSC_UNTICKBOX', utf8_encode('Existe un número limitado de este artículo en stock. Si el sotck se agota, este producto no estará disponible en la tienda a no ser que usted quite esta opción o añada más stock.'));

define('TXT_WPSC_LIMITED_STOCK', utf8_encode('Stock limitado'));



define('TXT_WPSC_CATEGORY', utf8_encode('Categoría'));
...
define('TXT_WPSC_FILETOBEPRODUCT', utf8_encode('Nota: Si está completado, el archivo subido será el producto para ser comprado.'));
...
define('TXT_WPSC_CATEGORY_PARENT', utf8_encode('Categoría padre'));
...
define('TXT_WPSC_PLEASEENTERAVALIDNAME', utf8_encode('Por favor introduzca un nombre válido'));

define('TXT_WPSC_PLEASEENTERAVALIDSURNAME', utf8_encode('Por favor introduzca un apellido válido'));

define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', utf8_encode('Por favor introduzca una dirección de correo válida'));

define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', utf8_encode('Por favor introduzca una dirección válida'));

define('TXT_WPSC_PLEASEENTERAVALIDPHONENUMBER', utf8_encode('Por favor introduzca un número de teléfono válido'));

define('TXT_WPSC_TERMSANDCONDITIONS', utf8_encode('Usted no está de acuerdo con las condiciones'));
...
define('TXT_WPSC_NOMOREAVAILABLE', utf8_encode('Este producto está fuera de stock'));
...
define('TXT_WPSC_YOURSHOPPINGCARTISEMPTY', utf8_encode('Su carrito de compra está vacío'));

define('TXT_WPSC_VISITTHESHOP', utf8_encode('Visitar tienda'));

define('TXT_WPSC_PAGES', utf8_encode('Páginas'));

define('TXT_WPSC_OUTOF', utf8_encode('Más de'));

define('TXT_WPSC_VOTES', utf8_encode('votos.'));

define('TXT_WPSC_CLICKSTARSTORATE', utf8_encode('Añada estrellas para calificar'));

define('TXT_WPSC_AVERAGERATINGOF', utf8_encode('Grado medio de'));

define('TXT_WPSC_YOURVOTE', utf8_encode('Su votación'));

define('TXT_WPSC_AVERAGEVOTE', utf8_encode('Media de votos'));

define('TXT_WPSC_YOUHAVEVOTED', utf8_encode('Usted ha votado'));

define('TXT_WPSC_NOVOTES', utf8_encode('Ningún voto'));
...
define('TXT_WPSC_ITEMHASBEENADDED', utf8_encode('El artículo se ha añadido'));

define('TXT_WPSC_ITEMHASNOTBEENADDED', utf8_encode('El artículo no se ha añadido'));

define('TXT_WPSC_ADDNEWCATEGORY', utf8_encode('Añadir nueva categoría'));

define('TXT_WPSC_SUBMIT', utf8_encode('Enviar'));

define('TXT_WPSC_SELECTAVALIDCATEGORY', utf8_encode('Por favor seleccione una categoría válida'));

define('TXT_WPSC_PRODUCTNAME', utf8_encode('Nombre del producto'));

define('TXT_WPSC_PRODUCTDESCRIPTION', utf8_encode('Descripción del producto'));

define('TXT_WPSC_ADDNEWPRODUCT', utf8_encode('Añadir producto'));
...
define('TXT_WPSC_ADDRESS', utf8_encode('Dirección'));

define('TXT_WPSC_ADDRESS1', utf8_encode('Dirección 1'));

define('TXT_WPSC_ADDRESS2', utf8_encode('Dirección 2'));

define('TXT_WPSC_CITY', utf8_encode('Ciudad'));

define('TXT_WPSC_COUNTRY', utf8_encode('País'));

define('TXT_WPSC_PHONE', utf8_encode('Teléfono'));
...
define('TXT_WPSC_CATEGORYHASBEENEDITED', utf8_encode('La categoría ha sido modificada'));

define('TXT_WPSC_DISPLAYCATEGORIES', utf8_encode('Mostrar categorías'));

define('TXT_WPSC_ADDCATEGORY', utf8_encode('Añadir categoría'));

define('TXT_WPSC_EDITCATEGORY', utf8_encode('Editar categoría'));

define('TXT_WPSC_ALLCATEGORIES', utf8_encode('Todas las categorías'));
...
define('TXT_WPSC_ADDPRODUCT', utf8_encode('Añadir producto'));
...
define('TXT_WPSC_ADDITIONALPRODUCTDESCRIPTION', utf8_encode('Descripción del producto adicional'));

define('TXT_WPSC_ADDITEM', utf8_encode('Añadir artículo'));

define('TXT_WPSC_CHOOSEACATEGORY', utf8_encode('Elija una categoría'));
...
define('TXT_WPSC_USERSCARTWASEMPTY', utf8_encode('Este carrito esta vacío'));
...
define('TXT_WPSC_TRANSACTIONDETAILSURL', utf8_encode('URL de detalles de la transacción'));

define('TXT_WPSC_PRESENTATIONSETTINGS', utf8_encode('Opciones de presentación'));

define('TXT_WPSC_CARTLOCATION', utf8_encode('Posición del carrito'));

define('TXT_WPSC_SIDEBAR', utf8_encode('Barra de menú'));

define('TXT_WPSC_PAGE', utf8_encode('Página'));
...
define('TXT_WPSC_SHOWPOSTAGEANDPACKAGING', utf8_encode('Mostrar gastos de envío'));
...
define('TXT_WPSC_CURRENCYSIGNLOCATION', utf8_encode('Símbolo de moneda del país'));

define('TXT_WPSC_DEFAULTPOSTAGEPACKAGING', utf8_encode('Franqueo y embalaje por defecto'));

define('TXT_WPSC_ADMINISTRATIONSETTINGS', utf8_encode('Opciones de administración'));
...
define('TXT_WPSC_NOITEMSINTHESHOPPINGCART', utf8_encode('No hay ningún artículo en el carrito'));

define('TXT_WPSC_EMAILMSG1', "Gracias, el pedido ha sido aceptado, será procesado y enviado lo más pronto posible, los elementos pueden ser descargados usando los enlaces.\n\r\n\rTodos los precios incluyen tasas y gastos de envío.\n\r\n\rDetalle de tu pedido:\n\r\n\r");

define('TXT_WPSC_EMAILMSG2', ".\n\rEstos artículos fueron pedidos:\n\r\n\r");

define('TXT_WPSC_CLICKTODOWNLOAD', utf8_encode('Pinche aquí para descargar'));

define('TXT_WPSC_DOWNLOAD', utf8_encode('Descargar'));

define('TXT_WPSC_YOURTRANSACTIONID', utf8_encode('Número de tu pedido'));
...
define('TXT_WPSC_THETRANSACTIONWASSUCCESSFUL', utf8_encode('Transacción correcta'));

define('TXT_WPSC_THETRANSACTIONWASNOTSUCCESSFUL', utf8_encode('Hubo un error en la transacción'));
...
define('TXT_WPSC_INSTRUCTIONS', utf8_encode('
  ...
  Para completar la instalación usted tiene que crear los productos, el carrito de compra, las páginas de la comprobación y el resultado de transacción, y luego ocultar la página del carrito, de la comprobación y de resultado de la transacción, de modo que  no aparezcan en la lista de páginas.

  <ul class=\'installation\'>

  <li>Subir el contenido del archivo zip dentro del directorio wp-content/plugins</li>

  <li>Activar el plugin desde la página de plugins de wordpress</li>
  ...
  <li>Crear las categorías y productos</li>
  ...
  Hemos terminado el desarrollo en un tiempo considerable, a pesar de todo hay que apoyar la eliminación de fallos de WP-E-commerce. Por lo tanto, si le gusta lo que usted ve, y quiere ver más de ello, puede ayudar a financiar futuras versiones es dejando caer un dólar o dos en el depósito de donaciones...</p>
  ...
  <p><strong>Tasas y gastos de envío</strong><br />Se pueden poner por defecto en la página de Opciones.</p>

  <p><strong>Email de Logs de compra</strong><br />Dirección para el envío de notificaciones de las compras.</p>

  <p><strong>Páginas ocultas</strong><br />

  Se debe buscar antes el ID de las páginas ocultas del carrito de compra y el resultado de las transacciones para evitar que sean mostradas.<br />
  ...
  <br />Editar la línea, por ejemplo así:<br />

  <br />"&lt;?php wp_list_pages(\'title_li=&lt;h2&gt;Pages&lt;h2&gt;&amp;exclude=3,4,5\')); ?&gt;"<br />

  <br />Las páginas son excluídas mediante su ID.</p>
  ...
  Si su servidor no tiene las funciones de imagen PHP instaladas, usted no será capaz de redimensionar las imágenes una vez subidas.</p>

  <p><strong>Permalinks</strong><br />

  Lo hacemos lo mejor que podemos.

  No he sido capaz de encontrar un modo realmente bueno de pasar las variables requeridas de la página A la página con permalinks que usan el modo reescritura (mod_rewrite), si usted se inclina en el empleo mod_rewrite,no puede trabajar con permalinks activado.</p>

  <p><strong>Javascript y Ajax </strong><br />

  E-commerce usa Ajax, el carrito de la compra no parece que utiliza Javascript, aunque detrás sí,pero las páginas de administración (específicamente las de Productos y Categorías) no lo usan. Para usar la sección de Administración usted tendrá que usar un navegador razonablemente moderno y tener Javascript activado. (Internet Explorer 6 o mejor, Firefox 1.0).</p>
...
define('TXT_WPSC_SHIPPINGSETTINGS', utf8_encode('Opciones de envío'));

define('TXT_WPSC_BASE_LOCAL', utf8_encode('Localidad base de envío'));

define('TXT_WPSC_BASE_INTERNATIONAL', utf8_encode('Envíos internacionales'));

define('TXT_WPSC_BASE_COUNTRY', utf8_encode('País base de envío'));



define('TXT_WPSC_SHIPPING_DETAILS', utf8_encode('Costes adicionales de envío')); // this needs updating

define('TXT_WPSC_LOCAL_PNP', utf8_encode('Coste de envío local')); // this needs updating

define('TXT_WPSC_INTERNATIONAL_PNP', utf8_encode('Coste de envío internacional')); // this needs updating

define('TXT_WPSC_SHIPPING_NOTE', utf8_encode('Nota: cobrado sólo una vez por producto independientemente de la cantidad pedida.'));

define('TXT_WPSC_COUNTRY_FORM_FIELD', utf8_encode('Campo de formulario para el país'));
...
define('TXT_WPSC_PRODUCTIMAGES', utf8_encode('Imágenes de productos'));

define('TXT_WPSC_PRODUCTDOWNLOAD', utf8_encode('Descargar producto'));

define('TXT_WPSC_SHOWTHUMBNAILS', utf8_encode('Ver Thumbnails'));

define('TXT_WPSC_ADD_ADDITIONAL_IMAGE', utf8_encode('Añadir imagen adicional'));

define('TXT_WPSC_DELETE_IMAGE', utf8_encode('Borrar imagen'));

define('TXT_WPSC_GOLD_OPTIONS', utf8_encode('Opciones de carrito oro'));

define('TXT_WPSC_ACTIVATE_SETTINGS', utf8_encode('Opciones de activación'));

define('TXT_WPSC_ACTIVATION_KEY', utf8_encode('KEY de activación'));

define('TXT_WPSC_THANKSACTIVATED', utf8_encode('Gracias, el carrito de compra versión oro ha sido activado.'));
...
define('TXT_WPSC_SHIPPING_COUNTRY', utf8_encode('Elija su país de envío:'));

define('TXT_WPSC_CONFIRM_TOTALS', utf8_encode('Verifique sus totales antes de realizar el pedido:'));

define('TXT_WPSC_CHECKOUT_FORM_FIELDS_DESCRIPTION', utf8_encode('Aquí usted puede personalizar las pasarelas de pago para que se muestren en su página de compra. La página de compra es donde usted recoge la información de usuario necesaria que se guardará en sus Logs de compra p. ej. la dirección de compradores, y el nombre...'));

define('TXT_WPSC_PAYMENT_OPTIONS', utf8_encode('Opciones de pago'));

define('TXT_WPSC_PAYMENT_DESCRIPTION', utf8_encode('Escoja las opciones de pago que usted quiere en la página de compra. Por defecto los clientes sólo pueden pagar los artículos con tarjeta de crédito, sin embargo usted puede darles la opción Cheque/Transferencia. En el caso de que usted quisiera esta opción, debería seleccionar la tarjeta de crédito más la opción de Cheque/Transferencia.'));



define('TXT_WPSC_DEFAULT_GATEWAY_ONLY', utf8_encode(' solo'));

define('TXT_WPSC_PLUS_MANUAL_PAYMENT', utf8_encode(' opción plus de pago Cheque/Transferencia'));

define('TXT_WPSC_PAYMENT_METHOD', utf8_encode('Método de pago'));

define('TXT_WPSC_PAY_USING', utf8_encode('Pago usado'));

define('TXT_WPSC_PAY_MANUALLY', utf8_encode('Pago por Cheque/Transferencia'));

define('TXT_WPSC_CREDIT_CARD', utf8_encode('Tarjeta de crédito'));

define('TXT_WPSC_ADJUSTABLE_QUANTITY', utf8_encode('Mostrar cantidades en modo lista'));

define('TXT_WPSC_RSS_FEED_HEADER', utf8_encode('Suscríbase a sus pedidos'));

define('TXT_WPSC_RSS_FEED_LINK', utf8_encode('Subscríbase a un RSS'));
...
define('TXT_WPSC_MP3_SETTINGS_DESCRIPTION', utf8_encode('Para crear MP3 de 30 segundos, este plugin necesita <a href=\'http://sox.sourceforge.net/\'>SoX</a> introduzca la ruta al SoX aquí.'));
...
define('TXT_WPSC_TOTALSHIPPING', utf8_encode('Gastos de envío totales'));

define('TXT_WPSC_DISPLAY_FRONT_PAGE', utf8_encode('Mostrar en página principal'));
